 ...
 * [AdventureFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [AdventureFragment.newInstance] factory method to
...
class AdventureFragment : Fragment() {
    ...
    private lateinit var adventureMovieRecyclerView: RecyclerView
    private lateinit var adventureMovieViewAdapter: RecyclerView.Adapter<*>
    private lateinit var adventureMovieViewManager: RecyclerView.LayoutManager
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_adventure, container, false)
        ...
        adventureMovieRecyclerView.adapter = adventureMovieViewAdapter
