 ...
 * [HorrorFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [HorrorFragment.newInstance] factory method to
...
class HorrorFragment : Fragment() {
    ...
    private lateinit var horrorMovieRecyclerView: RecyclerView
    private lateinit var horrorMovieViewAdapter: RecyclerView.Adapter<*>
    private lateinit var horrorMovieViewManager: RecyclerView.LayoutManager
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_action, container, false)
        ...
        horrorMovieRecyclerView.adapter = horrorMovieViewAdapter
